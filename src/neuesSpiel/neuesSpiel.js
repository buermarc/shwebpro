...
import stylesheet from "./neuesSpiel.css";
import overview from './neuesSpiel.html';


/**
 * View zum Anzeigen der offenen Runden des ausgewählten Spiels.
 */
class aktuelleSpiele {
  /**
   * Konstruktor.
   *
